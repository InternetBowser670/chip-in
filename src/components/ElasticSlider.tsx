...
const Slider: React.FC<SliderProps> = ({
  ...
  return (
    <>
        ...
        >
          ...
          >
            <div className="relative h-full grow overflow-hidden rounded-full bg-gray-200">
              <div className="absolute h-full bg-gray-800 rounded-full" style={{ width: `${getRangePercentage()}%` }} />
            </div>
          </motion.div>
        </div>
      ...
      <p className="absolute text-gray-200 transform -translate-y-4 text-xs font-medium tracking-wide">
        {Math.round(value)}
      </p>
    </>
  );
